...
const CreateEsotericOrder = () => {
  ...
  const handleSaveContent = useCallback(async () => {
    try {
      ...
      if (title === '') {
        ...
        const response = await api.post('/esoteric_orders', data);
  ...
  useEffect(() => {
    document.title = 'Cadastrar ordem esotérica';
  }, []);
  ...
  return (
    <Container>
      ...
      <Content>
        <HeaderContent title="Cadastrar ordem esotérica" />
        ...
        <Box>
          ...
          {isContentFocus && (
            <ContentEditor>
              <p className="success" hidden={!esotericOrder}>
